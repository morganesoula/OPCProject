 ...
 */
class AdvertSkill extends \OpenClassRoom\PlatformBundle\Entity\AdvertSkill implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OpenClassRoom\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'id', '' . "\0" . 'OpenClassRoom\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'level', '' . "\0" . 'OpenClassRoom\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'advert', '' . "\0" . 'OpenClassRoom\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'skill'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdvertSkill $proxy) {
